...
class Config:
    ...
    def get_user_config():
        ...
        # jira
        config['JIRA_URL'] = get_config('JIRA_URL', default=None, type=str, config=config)
        config['JIRA_PROJECT'] = get_config('JIRA_PROJECT', default=None, type=str, config=config)
        config['JIRA_USER'] = get_config('JIRA_USER', default=None, type=str, config=config)
        config['JIRA_PWD'] = get_config('JIRA_PWD', default=None, type=str, config=config)

        # zabbix
        config['ZABBIX_SEVERITY_MAPPING'] = get_config('ZABBIX_SEVERITY_MAPPING', default=None, type=str, config=config)
