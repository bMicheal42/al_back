...
# CORS settings
CORS_ALLOW_HEADERS = ['Content-Type', 'Authorization', 'Access-Control-Allow-Origin', 'X-Request-ID', 'X-TimeStamp']
CORS_ORIGINS = [
    # 'https://try.alerta.io',
...
DATE_FORMAT_SHORT_TIME = 'HH:mm:ss'  # eg. 09:24
...
ASI_SEVERITY = [
    'critical', 'high', 'medium', 'indeterminate'
]
ASI_QUERIES = [
