...
class Backend(Database):
    ...
    def mass_update_attributes(self, updates: List[Dict[str, Any]] = None):
        raise NotImplementedError
    ...
    def create_pattern(self, name, sql_rule, priority, is_active):
        raise NotImplementedError
    ...
    def add_pattern_history(self, pattern_name: str, pattern_id: str, incident_id: str, alert_id: str):
        raise NotImplementedError
